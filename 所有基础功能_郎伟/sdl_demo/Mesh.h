...
struct MeshFace
{
	...
	MeshFace(Vector3 *v1, Vector3 *v2, Vector3 *v3,
...
public:
	...
	//调试
	MeshMaterial &getMeshMaterial(void);

	//调试
	void exportMesh(FILE *ptr,float *modelview, int *numv, int *numvt, int *numvn);

protected:
	void drawFace(MeshFace *face);
